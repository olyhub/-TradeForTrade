...
SECRET_KEY = 'g&8xgw^yxfaf#0ruv-&$div2z20c^&v$d%_415i$obc%*_rf=i'
...
STRIPE_PUBLISHABLE = os.getenv('STRIPE_PUBLISHABLE', 'pk_test_JK1K2pKB30Kjg61bPG0iCqtx')
STRIPE_SECRET = os.getenv('STRIPE_SECRET', 'sk_test_2JRAn5iuoVszQjyBtKFRO5VL')
